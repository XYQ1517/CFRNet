...
imgpath = '../data/deepglobe/images'
txtsavepath = '../data/deepglobe/'

imgtxt_1 = open('../data/deepglobe/train.txt', 'w')
imgtxt_2 = open('../data/deepglobe/val.txt', 'w')
imgtxt_3 = open('../data/deepglobe/test.txt', 'w')
